(* OASIS_START *)
(* DO NOT EDIT (digest: a442e1c5a2e0de842eec1fad58c344ab) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("session", ["lib"], []);
          ("session_redis_lwt", ["backends/redis"], []);
          ...
          ("session_cohttp_lwt", ["cohttp"], []);
          ("session_webmachine", ["webmachine"], [])
       ];
     lib_c = [];
     flags = [];
     includes =
       [
          ("webmachine", ["cohttp"]);
          ("lib_test", ["backends/postgresql"; "backends/redis"; "lib"]);
          ("examples", ["cohttp"; "webmachine"]);
          ("cohttp", ["lib"]);
          ("backends/redis", ["lib"]);
          ("backends/postgresql", ["lib"])
       ]
  }
  ;;
