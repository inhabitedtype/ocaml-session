...
(* OASIS_START *)
(* DO NOT EDIT (digest: f4254d982907bca65687a02f69b0fb42) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_memory_backend", []))];
          ...
          ("test_postgresql_backend",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_postgresql_backend", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_redis_backend",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_redis_backend", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/inhabitedtype/ocaml-session";
          bugreports = None;
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the postgresql library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the redis library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "test the redis library against a localhost Redis instance";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the cohttp libraries";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the webmachine library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Async libraries";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the lwt libraries";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lift"; "Memory"; "S"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "session";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "session_redis_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "backends/redis";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("nocrypto", None);
                           FindlibPackage ("redis.lwt", None);
                           FindlibPackage ("result", None);
                           InternalLibrary "session"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["Session_redis_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session";
                      lib_findlib_name = Some "redis-lwt";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "session_postgresql";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "postgresql", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                   ...
                   {
                      lib_modules = ["Session_postgresql"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session";
               ...
               Library
                 ({
                     cs_name = "session_postgresql_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("postgresql", None);
                           FindlibPackage ("result", None);
                           InternalLibrary "session_postgresql";
                           FindlibPackage ("threads", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules = ["Session_postgresql_async"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session";
                      lib_findlib_name = Some "postgresql-async";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "session_postgresql_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Session_postgresql_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session";
                      lib_findlib_name = Some "postgresql-lwt";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "session_cohttp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("result", None);
                           InternalLibrary "session_cohttp";
                           FindlibPackage ("threads", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules = ["Session_cohttp_async"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session";
                      lib_findlib_name = Some "cohttp-async";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "session_cohttp_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Session_cohttp_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session";
                      lib_findlib_name = Some "cohttp-lwt";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "session_webmachine";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("webmachine", None);
                           FindlibPackage ("result", None);
                           InternalLibrary "session_cohttp"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   {
                      lib_modules = ["Session_webmachine"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "session";
                      lib_findlib_name = Some "webmachine";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "A session manager for your everyday needs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "session_cohttp_lwt";
                           FindlibPackage ("result", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "cohttp_lwt_counter.ml"
                   });
               Executable
                 ({
                     cs_name = "cohttp_async_counter";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("nocrypto.unix", None);
                           InternalLibrary "session_cohttp_async";
                           FindlibPackage ("result", None);
                           FindlibPackage ("threads", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "cohttp_async_counter.ml"
                   });
               Executable
                 ({
                     cs_name = "webmachine_lwt_counter";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("cohttp.lwt", None);
                           FindlibPackage ("nocrypto.unix", None);
                           InternalLibrary "session_webmachine";
                           FindlibPackage ("result", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "webmachine_lwt_counter.ml"
                   });
               Executable
                 ({
                     cs_name = "webmachine_async_counter";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "webmachine_async_counter.ml"
                   });
               Executable
                 ({
                     cs_name = "test_memory_backend";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_memory_backend.ml"
                   });
               Executable
                 ({
                     cs_name = "test_postgresql_backend";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_postgresql_backend.ml"
                   });
               Executable
                 ({
                     cs_name = "test_redis_backend";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("nocrypto.unix", None);
                           FindlibPackage ("redis", None);
                           InternalLibrary "session_redis_lwt";
                           FindlibPackage ("result", None);
                           FindlibPackage
                             ("oUnit",
                               Some (OASISVersion.VGreaterEqual "1.0.2"))
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_redis_backend.ml"
                   });
               Test
                 ({
                     cs_name = "test_memory_backend";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/inhabitedtype/ocaml-session.git";
                      src_repo_browser =
                        Some "https://github.com/inhabitedtype/ocaml-session";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "]L\214\169\027\210\158\193R\152\007\245W\\t\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
